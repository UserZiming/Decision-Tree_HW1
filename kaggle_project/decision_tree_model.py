...
tree = decision_tree.DecisionTree(train_df, attribute_types, depth)
predict_train = tree.testing(train_df.drop(columns=['label']))
prediction = tree.testing(test_df.drop(columns=['ID']))
