...
def Question_2d():
    ...
    # sub_set_size = 4
    sub_set_size = 6
    print("Feature subset from ", sub_set_size)
    out = randomForest.rand_forest(train_dataSet, test_dataSet, attributes_types, T, sub_set_size)
    print(out)
    ...
    ax1.set_title("Random Forest Tree")
    plt.legend()
    plt.show()
